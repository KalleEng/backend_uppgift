...
public class Blacklist implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        System.out.println("Initial status: " + isOk(email));
        setAsBad(email);
        System.out.println("After setAsBad: " + isOk(email));
        setAsOk(email);
        System.out.println("After setAsOk: " + isOk(email));
         */

        //add("new@gmail.com", "alex", false);
        //upsert("blacklisted2@hotmail.com", "Al", false);
        //upsert("random@mail.com", "Johnny", false);
    }
}