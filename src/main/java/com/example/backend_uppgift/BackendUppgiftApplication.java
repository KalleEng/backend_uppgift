...
import com.example.backend_uppgift.controllers.BookingController;
import com.example.backend_uppgift.controllers.CustomerController;
...
public class BackendUppgiftApplication {
    ...
    public CommandLineRunner demo(BookingRepo bookingRepo, CustomerRepo customerRepo, RoomRepo roomRepo){
        return (args -> {
            ...
            customerRepo.save(new Customer("Hidro Kourkis","hidro@example.com"));
